...
def parse_args():
    ...
    parser.add_argument('--project_name', type=str, default="siglip-stable-diffusion-multi-node", help="Name of WandB project")
    parser.add_argument("--run_name", type=str, default="siglip_sd_run", help="Name of the WandB run")
